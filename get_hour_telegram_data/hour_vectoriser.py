...
def main():
    telegram_data_path = 'hour_parsed_telegram_data.csv'
    ...
    current_dir = Path(__file__).parent
    main_telegram_data_path = current_dir.parent / 'telegram_vectoriser' / 'vectorised_telegram_data.csv'
    df = pd.read_csv(main_telegram_data_path, delimiter=",")
    ...
    df.to_csv(main_telegram_data_path, index=False)
